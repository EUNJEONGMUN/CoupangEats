...
//      
    ...
    public int createReviewUrl(int userIdx, int userOrderIdx, PostReviewUrlReq postReviewReq, List<String> imageList) {
...
//        }
     ...
     * @return BaseResponse<String>
     */
    public int modifyReviewUrl(int userIdx, int reviewIdx, PutReviewUrlReq putReviewReq, List<String> imageList) {
        // 매장, 배달 모두 좋아요
        String InsertReviewInfoQuery1 = "UPDATE Review SET score=?, content=?, isPhoto=?, isDeliveryGood=? WHERE reviewIdx=?;";
